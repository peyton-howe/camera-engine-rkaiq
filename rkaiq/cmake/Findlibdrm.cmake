...
if(libdrm_FOUND OR libdrm_rockchip_FOUND)
    if(libdrm_rockchip_FOUND)
        ...
        set(LIBDRM_INCLUDE_DIRS ${LIBDRM_XF86DRM_INCLUDE_DIR} "${LIBDRM_XF86DRM_INCLUDE_DIR}/libdrm")
	set(LIBDRM_CFLAGS "-DHAS_LIBDRM" "-I${LIBDRM_INCLUDE_DIRS}")
	message(STATUS "LIBDRM library found")
        message(STATUS "    version: ${LIBDRM_XF86DRM_INCLUDE_DIR}")
        message(STATUS "    libraries: ${LIBDRM_LIBRARY}")
